...
5. Opens **Defects → Defect Pattern Analyzer** → picks **Last 30 days** → clicks **Analyze Patterns**. Reads from the live defects DB (16 Jamkrindo defects across sprints 22–24). Pattern `Penjaminan / ICPR / Integration Timeout` recurs **4×**, escalating 1 → 1 → 2 → 6 certs dropped per run. Heatmap top risk: **Penjaminan / ICPR** (risk score 75). 2 Critical defects still OPEN: DEF-2026-0130 (ICPR), DEF-2026-0129 (NULL NIK).
